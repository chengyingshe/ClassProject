...
ROOT_PATH = '/home/scy/ComputerGraphics/LiDARCap/data/lidarhuman26M'
...
if __name__ == '__main__':
    ...
    parser_dump.add_argument('--output', type=str, default='lidarhuman26M_extra')
    ...
    extras_path = os.path.join(os.path.dirname(ROOT_PATH), args.output)
    print('extras_path:', extras_path)
