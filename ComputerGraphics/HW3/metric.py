...
def output_metric(pred_poses, gt_poses, output_metric_file_name):
    ...
    print()
    save_metric(output_metric_file_name, accel_error, mpjpe, pa_mpjpe, pve, pck_30, pck_50)
    

def save_metric(file_name, accel_error, mpjpe, pa_mpjpe, pve, pck_30, pck_50):
    with open(file_name, 'w') as f:
        f.write(f'accel_error: {accel_error}\n')
        f.write(f'mpjpe: {mpjpe}\n')
        f.write(f'pa_mpjpe: {pa_mpjpe}\n')
        f.write(f'pve: {pve}\n')
        f.write(f'pck_30:{pck_30}\n')
        f.write(f'pck_50:{pck_50}')
